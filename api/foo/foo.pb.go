...
type RequestInput struct {
	...
	Data                 *bar.SomeModel `protobuf:"bytes,3,opt,name=data,proto3" json:"data,omitempty"`
...
func (*RequestInput) Descriptor() ([]byte, []int) {
	return fileDescriptor_ae59da4b24358dd1, []int{0}
}
...
func (m *RequestInput) GetA() string {
	if m != nil {
		return m.A
	}
	return ""
...
func (m *RequestInput) GetB() int64 {
	if m != nil {
		return m.B
	}
	return 0
...
func (m *RequestInput) GetData() *bar.SomeModel {
	if m != nil {
		return m.Data
	}
	return nil
...
func (*RequestOutput) Descriptor() ([]byte, []int) {
	return fileDescriptor_ae59da4b24358dd1, []int{1}
}
...
func init() {
	proto.RegisterType((*RequestInput)(nil), "foo.RequestInput")
	proto.RegisterType((*RequestOutput)(nil), "foo.RequestOutput")
}

func init() { proto.RegisterFile("api/foo/foo.proto", fileDescriptor_ae59da4b24358dd1) }

var fileDescriptor_ae59da4b24358dd1 = []byte{
	// 201 bytes of a gzipped FileDescriptorProto
	,
}
...
// FooServerClient is the client API for FooServer service.
//
// For semantics around ctx use and closing/ending streaming RPCs, please refer to https://godoc.org/google.golang.org/grpc#ClientConn.NewStream.
type FooServerClient interface {
	Request(ctx context.Context, in *RequestInput, opts ...grpc.CallOption) (*RequestOutput, error)
}

type fooServerClient struct {
	cc *grpc.ClientConn
}

func NewFooServerClient(cc *grpc.ClientConn) FooServerClient {
	return &fooServerClient{cc}
}

func (c *fooServerClient) Request(ctx context.Context, in *RequestInput, opts ...grpc.CallOption) (*RequestOutput, error) {
	out := new(RequestOutput)
	err := c.cc.Invoke(ctx, "/foo.FooServer/Request", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// FooServerServer is the server API for FooServer service.
type FooServerServer interface {
	Request(context.Context, *RequestInput) (*RequestOutput, error)
}

// UnimplementedFooServerServer can be embedded to have forward compatible implementations.
type UnimplementedFooServerServer struct {
}

func (*UnimplementedFooServerServer) Request(ctx context.Context, req *RequestInput) (*RequestOutput, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Request not implemented")
}

func RegisterFooServerServer(s *grpc.Server, srv FooServerServer) {
	s.RegisterService(&_FooServer_serviceDesc, srv)
}

func _FooServer_Request_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(RequestInput)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(FooServerServer).Request(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/foo.FooServer/Request",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(FooServerServer).Request(ctx, req.(*RequestInput))
	}
	return interceptor(ctx, in, info, handler)
}

var _FooServer_serviceDesc = grpc.ServiceDesc{
	ServiceName: "foo.FooServer",
	HandlerType: (*FooServerServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "Request",
			Handler:    _FooServer_Request_Handler,
		},
	},
	...
	if m.Data != nil {
		{
			...
			i -= size
			i = encodeVarintFoo(dAtA, i, uint64(size))
		}
		i--
		dAtA[i] = 0x1a
	}
